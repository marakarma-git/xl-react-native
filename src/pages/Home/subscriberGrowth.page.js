...
import LineChartSubGrowth from './../../components/widget/lineChartSubGrowth';
...
const SubscriberGrowthPage = ({navigation}) => {
            ...
            <View style={{
                ...
                <View style={{margin: 20,
                    ...
                    <View 
                        ...
                        />
                        <Text style={{ paddingTop:5 }}>Total Billable SIMs</Text>
                    </View>
                    ...
                    <View 
                        ...
                        />
                        <Text style={{ paddingTop:5 }}>Gross Add</Text>
                    </View>
                    ...
                    <View 
                        ...
                        />
                        <Text style={{ paddingTop:5 }}>Chum</Text>
                    </View>
                    ...
                    <View 
                        ...
                        />
                        <Text style={{ paddingTop:5 }}>Net Add</Text>
                    </View>
...
export default SubscriberGrowthPage;
