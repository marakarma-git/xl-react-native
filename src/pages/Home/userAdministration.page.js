        ...
        <Table
          ...
          headerOtherLayout={() => {
            return (
              <>
                <OverlayBackground />
                <View style={subscriptionStyle.headerButtonContainer}>
                  <TouchableOpacity
                    onPress={() => navigation.navigate("Create User")}
                    style={subscriptionStyle.headerButtonCreate}>
                    <Text style={subscriptionStyle.headerButtonCreateText}>Create New User</Text>
                  </TouchableOpacity>
                </View>
                <SearchHeader
                  value={''}
