const reduxString = {
  ...
  SET_PACKAGE_NAME_LIST: 'SET_PACKAGE_NAME_LIST',
  SET_CAROUSEL: 'SET_CAROUSEL',
  SET_SIM_STATISTICS: 'SET_SIM_STATISTICS',
  SET_CUSTOM_STATISTICS: 'SET_CUSTOM_STATISTICS',
  SET_FINANCIAL_REPORT: 'SET_FINANCIAL_REPORT',
  SET_TOP_TRAFFIC_STATISTICS: 'SET_TOP_TRAFFIC_STATISTICS',
  SET_TOP_DEVICE_BRAND: 'SET_TOP_DEVICE_BRAND',
  SET_DEVICE_POPULATION: 'SET_DEVICE_POPULATION',
  ...
  SET_DEVICE_ANALYTIC: 'SET_DEVICE_ANALYTIC',
  REQUEST_WIDGET_DATA: 'REQUEST_WIDGET_DATA',
  REQUEST_ENTERPRISE_DATA: 'REQUEST_ENTERPRISE_DATA',
  REQUEST_AGGREGATED_TRAFFIC: 'REQUEST_AGGREGATED_TRAFFIC',
  REQUEST_TOP_TRAFFIC: 'REQUEST_TOP_TRAFFIC',
  REQUEST_TOP_DEVICE_BRAND: 'REQUEST_TOP_DEVICE_BRAND',
  REQUEST_DEVICE_POPULATION: 'REQUEST_DEVICE_POPULATION',
  REQUEST_CUSTOM_STATISTICS: 'REQUEST_CUSTOM_STATISTICS',
  REQUEST_FINANCE_REPORT: 'REQUEST_FINANCE_REPORT',
  REQUEST_DEVICE_ANALYTIC: 'REQUEST_DEVICE_ANALYTIC',
  ...
  SAVE_BUSINESS_CATEGORY: 'SAVE_BUSINESS_CATEGORY',
  SAVE_BUSINESS_CATEGORY_FIELD_TYPE: 'SAVE_BUSINESS_CATEGORY_FIELD_TYPE',
  SAVE_CUSTOM_LABEL: 'SAVE_CUSTOM_LABEL',
  RESET_CUSTOM_LABEL: 'RESET_CUSTOM_LABEL',
  SAVE_ENTERPRISE_DETAIL: 'SAVE_ENTERPRISE_DETAIL',
  RESET_ENTERPRISE_DETAIL: 'RESET_ENTERPRISE_DETAIL',
  ENTERPRISE_MANAGEMENT_SET_DETAIL_PARAMS:
    'ENTERPRISE_MANAGEMENT_SET_DETAIL_PARAMS',
  SET_ENTERPRISE_MANAGEMENT_EDIT_PERMISSION:
    'SET_ENTERPRISE_MANAGEMENT_EDIT_PERMISSION',
  ...
  HARD_CODE_CURRENT_TOTAL_ELEMENTS: 'HARD_CODE_CURRENT_TOTAL_ELEMENTS',
  ...
  SUBSCRIPTION_PACKAGE_REPLACE_CELL_WITH_INDEX:
    'SUBSCRIPTION_PACKAGE_REPLACE_CELL_WITH_INDEX',
  ...
  ENTERPRISE_MANAGEMENT_DYNAMIC_ONCHANGE_DROP_DOWN:
    'ENTERPRISE_MANAGEMENT_DYNAMIC_ONCHANGE_DROP_DOWN',
  ENTERPRISE_MANAGEMENT_DYNAMIC_ONCHANGE_DATE_TIME_PICKER:
    'ENTERPRISE_MANAGEMENT_DYNAMIC_ONCHANGE_DATE_TIME_PICKER',
  ...
  AUTOMATION_CONTAINER_SWITCH: 'AUTOMATION_CONTAINER_SWITCH',
  AUTOMATION_ADAPTIVE_ONCHANGE: 'AUTOMATION_ADAPTIVE_ONCHANGE',
  AUTOMATION_RESET_FORM_CONTAINER_VALUE:
    'AUTOMATION_RESET_FORM_CONTAINER_VALUE',
  AUTOMATION_CREATE_REDUX_LOADING: 'AUTOMATION_CREATE_REDUX_LOADING',
  AUTOMATION_CREATE_REDUX_LOADING_FALSE:
    'AUTOMATION_CREATE_REDUX_LOADING_FALSE',
  AUTOMATION_CREATE_REDUX_ERROR: 'AUTOMATION_CREATE_REDUX_ERROR',
  AUTOMATION_ENTERPRISE_SUCCESS: 'AUTOMATION_ENTERPRISE_SUCCESS',
  AUTOMATION_ACTIVE_ENTERPRISE_SUCCESS: 'AUTOMATION_ACTIVE_ENTERPRISE_SUCCESS',
  AUTOMATION_ELEMENT_STATIC_PLUS_ONE: 'AUTOMATION_ELEMENT_STATIC_PLUS_ONE',
  AUTOMATION_ELEMENT_STATIC_MINUS_ONE: 'AUTOMATION_ELEMENT_STATIC_MINUS_ONE',
  ...
  SMS_A2P_EDIT_TEXT_INPUT: 'SMS_A2P_EDIT_TEXT_INPUT',
  SMS_A2P_EDIT_DROP_DOWN: 'SMS_A2P_EDIT_DROP_DOWN',
  SMS_A2P_EDIT_LOADING: 'SMS_A2P_EDIT_LOADING',
  SMS_A2P_EDIT_REMOVE_LOADING: 'SMS_A2P_EDIT_REMOVE_LOADING',
  SMS_A2P_EDIT_SUCCESS: 'SMS_A2P_EDIT_SUCCESS',
  SMS_A2P_EDIT_FAILED: 'SMS_A2P_EDIT_FAILED',
  SMS_A2P_EDIT_DYNAMIC_FORM_FAILED: '',
  SMS_A2P_EDIT_RESET: 'SMS_A2P_EDIT_RESET',
  SMS_A2P_REPLACE_CELL_WITH_INDEX: 'SMS_A2P_REPLACE_CELL_WITH_INDEX',
  SMS_A2P_TOTAL_PLUS_ONE: 'SMS_A2P_TOTAL_PLUS_ONE',
  SMS_A2P_TOTAL_MINUS_ONE: 'SMS_A2P_TOTAL_MINUS_ONE',
  ...
  GEO_DISTRIBUTION_SET_TO_DEFAULT: 'GEO_DISTRIBUTION_SET_TO_DEFAULT',

  REALTIME_DIAGNOSTIC_GET_SIM_DATA: 'REALTIME_DIAGNOSTIC_GET_SIM_DATA',
  REALTIME_DIAGNOSTIC_REQUEST_SIM_DATA: 'REALTIME_DIAGNOSTIC_REQUEST_SIM_DATA',
  REALTIME_DIAGNOSTIC_RESET_SIM_DATA: 'REALTIME_DIAGNOSTIC_RESET_SIM_DATA',
  REALTIME_DIAGNOSTIC_SET_ERROR: 'REALTIME_DIAGNOSTIC_SET_ERROR',
  REALTIME_DIAGNOSTIC_SET_SUCCESS: 'REALTIME_DIAGNOSTIC_SET_SUCCESS',
  REALTIME_DIAGNOSTIC_GET_SIM_STATUS: 'REALTIME_DIAGNOSTIC_GET_SIM_STATUS',
  REALTIME_DIAGNOSTIC_REQUEST_SIM_STATUS:
    'REALTIME_DIAGNOSTIC_REQUEST_SIM_STATUS',
  REALTIME_DIAGNOSTIC_RESET_SIM_STATUS: 'REALTIME_DIAGNOSTIC_RESET_SIM_STATUS',
  REALTIME_DIAGNOSTIC_FIX_STATUS_LOADING:
    'REALTIME_DIAGNOSTIC_FIX_STATUS_LOADING',
  BULK_RECONNECT_LOADING: 'BULK_RECONNECT_LOADING',
  BULK_RECONNECT_FAILED: 'BULK_RECONNECT_FAILED',
  BULK_RECONNECT_SUCCESS: 'BULK_RECONNECT_SUCCESS',
};
