...
const ModalConfirmation = (props) => {
    ...
    <Modal animationType="slide" 
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <KeyboardAvoidingView style={[inputHybridStyle.multiSessionModal, { borderRadius: 5, width: '85%' }]}>
                <View style={[inputHybridStyle.tcTitleContainer, { borderTopRightRadius: 5, borderTopLeftRadius: 5 }]}>
                ...
                <View style={inputHybridStyle.modalFooter}>
                    <View style={inputHybridStyle.buttonContainer}>
                        <TouchableOpacity
                            ...
                            style={
                              [
                                ...
                                { borderRadius: 5, backgroundColor: '#CBC9C9', borderColor: '#CBC9C9' }
                              ]
                              }>
                        ...
                        <TouchableOpacity
                                ...
                                style={[inputHybridStyle.buttonNext, { borderRadius: 5, borderColor: 'none' }]}>
