    ...
    activity: [
      {
        action: '',
        actionCode: 'AL1',
        description: 'Generate Table List',
        privId: 'adfda120-1193-4ea1-bf35-e3ed3ee2be48',
        impactOn: 'View Activity Log',
      },
      {
        action: '',
        actionCode: 'AL2',
        description: 'Search/Filter',
        privId: 'a7d61448-56ff-11eb-ae93-0242ac130002',
        impactOn: 'Filter',
      },
    ],
  },
    ...
    activity: [
      {
        action: '',
        actionCode: 'BM1',
        description: 'Swapping Banner Order',
        privId: 'ee1a50ee-6439-11eb-ae93-0242ac130002',
        impactOn: 'Banner Management: Arrange Order',
      },
      {
        action: '',
        actionCode: 'BM2',
        description: 'Generate Table List',
        privId: '',
        impactOn: 'Banner Management: View',
      },
      {
        action: 'SET_CAROUSEL',
        actionCode: 'BM3',
        description: 'Generate Banner Image',
        privId: 'ee1a4b4e-6439-11eb-ae93-0242ac130002',
        impactOn: 'Banner Management: Banner Image',
      },
      {
        action: '',
        actionCode: 'BM4',
        description: 'Create Banner',
        privId: 'ee1a4c20-6439-11eb-ae93-0242ac130002',
        impactOn: 'Banner Management: Create',
      },
      {
        action: '',
        actionCode: 'BM5',
        description: 'Edit Banner',
        privId: 'ee1a4cde-6439-11eb-ae93-0242ac130002',
        impactOn: 'Banner Management: Edit',
      },
      {
        action: '',
        actionCode: 'BM6',
        description: 'Delete Banner',
        privId: 'ee1a4fea-6439-11eb-ae93-0242ac130002',
        impactOn: 'Banner Management: Delete',
      },
    ],
  },
  {
    ...
    activity: [
      {
        ...
        impactOn: 'Edit Enterprise',
      },
      {
        action: '',
        actionCode: 'EM2',
        description: 'View Enterprise List (Tree View)',
        privId: '4acca400-7245-11ea-bc55-0242ac130003',
        impactOn: 'View Enterprise List (Tree View)',
      },
      {
        action: '',
        actionCode: 'EM3',
        ...
        impactOn: 'Create New Enterprise',
      },
    ],
  },
  {
    ...
    activity: [
      {
        ...
        impactOn: 'Search & Filter',
      },
      {
        action: '',
        actionCode: 'SB2',
        description: 'Pause SIM',
      ...
      },
      {
        action: '',
        actionCode: 'SB3',
        description: 'Bulk Update Label',
        privId: '4acc9924-7245-11ea-bc55-0242ac130003',
        impactOn: 'Bulk Update Label',
      },
      {
        action: '',
        actionCode: 'SB4',
        ...
        impactOn: 'Deactivate SIM',
      },
      {
        action: '',
        actionCode: 'SB5',
        description: 'Terminate SIM',
        privId: '4acc985c-7245-11ea-bc55-0242ac130003',
        impactOn: 'Terminate SIM',
      },
      {
        action: '',
        actionCode: 'SB6',
        description: 'View SIM Inventory',
        privId: '4acc9528-7245-11ea-bc55-0242ac130003',
        impactOn: 'View SIM Inventory',
      },
      {
        action: '',
        actionCode: 'SB7',
        ...
        impactOn: 'Activate SIM',
      },
      {
        action: '',
        actionCode: 'SB8',
        description: 'See SIM Location',
        privId: '4acc9c94-7245-11ea-bc55-0242ac130003',
        impactOn: 'See SIM Location',
      },
    ],
  },
  {
    ...
    activity: [
      {
        action: '',
        actionCode: 'SP1',
        description: 'View Subscription Package',
        privId: '50b49572-8d01-11ea-bc55-0242ac130003',
        impactOn: 'View Subscription Package',
      },
      {
        action: '',
        actionCode: 'SP2',
      ...
      },
      {
        ...
        impactOn: 'Filter Data',
      },
      {
        action: '',
        actionCode: 'SP4',
        description: 'Update Data 1 by 1',
        privId: '50b49a7c-8d01-11ea-bc55-0242ac130003',
        impactOn: 'Update Data 1 by 1',
      },
      {
        action: '',
        actionCode: 'SP5',
    ...
    activity: [
      {
        action: '',
        actionCode: 'CC',
        description: 'View Customer Consent',
        privId: 'b1aef948-7d5c-11eb-9439-0242ac130002',
        impactOn: 'View Customer Consent',
      },
    ],
  },
  {
